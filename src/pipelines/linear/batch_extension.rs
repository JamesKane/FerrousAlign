...
// ============================================================================
// PARALLEL SUB-BATCH PROCESSING (OPTIMIZED)
// ============================================================================
//
// This implementation matches BWA-MEM2's approach:
// - Split reads into sub-batches of ~512 reads (BATCH_SIZE from C++)
// - Process sub-batches IN PARALLEL using rayon
// - Within each sub-batch, use cross-read batching for SIMD scoring
//
