...
// Only compile on x86_64 with avx512 feature to avoid ARM build errors
...
mod avx512_tests {
    ...
    fn _avx512_i16_deterministic_cases() {
        ...
        // TODO: Update to use new SoA API
    ...
    fn _avx512_i16_randomized_small_batches() {
        ...
        let _batch_s: Vec<(i32, &[u8], i32, &[u8], i32, i32)> = batch
            .iter()
